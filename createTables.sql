...
CREATE UNLOGGED TABLE Degrees(DegreeId int UNIQUE, Dept varchar(50), DegreeDescription varchar(200), TotalECTS smallint);
...
CREATE UNLOGGED TABLE Teachers(TeacherId int UNIQUE, TeacherName varchar(200), Address varchar(200), BirthyearTeacher smallint, Gender char);
...
CREATE UNLOGGED TABLE Courses(CourseId int UNIQUE, CourseName varchar(50), CourseDescription varchar(200), DegreeId int,ECTS smallint);
